...
class _FormMahasiswaPageState extends State<FormMahasiswaPage> {
  ...
  String get tglLahirLabel =>
      tglLahir == null ? 'Pilih Tanggal Lahir' : '${tglLahir!.day}/${tglLahir!.month}/${tglLahir!.year}';
  
  String get jamLabel =>
      jamBimbingan == null ? 'Pilih Jam Bimbingan' : '${jamBimbingan!.hour}:${jamBimbingan!.minute}';
              ...
              children: [
                ...
                TextFormField(
                    ...
                    validator: (v) {
                      ...
                      final ok = RegExp(r"^[a-zA-Z0-9.]+@unsika\.ac\.id$").hasMatch(v.trim());
                      return ok ? null : 'Format email salah (contoh: nama@unsika.ac.id)';
                    }),
                const SizedBox(height: 16),
                TextFormField(
                  controller: cAlamat,
